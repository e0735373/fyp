...
for env_name, kwargs in [
        ...
        # {}
         ...
         ("mysokoban-n8-b2_custom",
         { 'render' : mysokoban_render }
         ),
         ("mymaze", {'render' : maze_render}),
        ("myhanoi", {'render' : hanoi_render}),
        ("myhanoi_classic", {'render' : hanoi_render}),
        ("mypath", {'render' : mypath_render}),
        ("mypath_line", {'render' : mypath_render}),
        ("mypath_star", {'render' : mypath_render}),
        ("mypath_cycle", {'render' : mypath_render}),
        ("mypath_multi", {'render' : mypath_render}),
        ("mypath_anti", {'render' : mypath_render}),
        ("mysudoku", {'render' : mysudoku_render}),
        ("mysudoku_init", {'render' : mysudoku_render}),
]:
    other_args = {
